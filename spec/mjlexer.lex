...
">"			{ return new_symbol(sym.BIGGERTHAN, yytext()); }
">="		{ return new_symbol(sym.BIGGEROREQUALTHAN, yytext()); }
"<"			{ return new_symbol(sym.SMALLERTHAN, yytext()); }
"<="		{ return new_symbol(sym.SMALLEROREQUALTHAN, yytext()); }
