...
public class FormParsList_recursive extends FormParsList {

    private FormPars FormPars;
    private FormParsMore FormParsMore;

    public FormParsList_recursive (FormPars FormPars, FormParsMore FormParsMore) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FormParsList_recursive(\n");
