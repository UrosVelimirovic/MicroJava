...
public class CondFact_expr_relop_expr extends CondFact {

    private NonTernaryExpr NonTernaryExpr;
    private Relop Relop;
    private NonTernaryExpr NonTernaryExpr1;

    public CondFact_expr_relop_expr (NonTernaryExpr NonTernaryExpr, Relop Relop, NonTernaryExpr NonTernaryExpr1) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("CondFact_expr_relop_expr(\n");
